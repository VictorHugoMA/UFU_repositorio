...
--Trabalho: Produção de Um Recibo Fiscal em um Supermercado
...
--funcao que formata varias listas usando recurssao
formataLinhas :: [(Nome,Preco)] -> String
formataLinhas [] = []
formataLinhas (x:xs) = formataLinha x ++ formataLinhas xs

--funcao que soma o preco dos itens dentro das tuplas fazendo chamadas recurssivas
...
--funcao que dado uma lista de codigos de barras devolve os itens e precos correspondentes
