...
--ANTES E DEPOIS
SELECT NOME_CLIENTE, SUM() FROM DEPOSITO 
GROUP BY NOME_CLIENTE ORDER BY SUM();

UPDATE DEPOSITO SET SALDO_DEPOSITO =  * 1.01;
...
--ANTES E DEPOIS
SELECT , SUM() FROM DEPOSITO 
GROUP BY  ORDER BY SUM();

UPDATE  SET SALDO_DEPOSITO =  * 1.05
WHERE  <= 10000;

UPDATE  SET SALDO_DEPOSITO =  * 1.03
WHERE  > 10000;
